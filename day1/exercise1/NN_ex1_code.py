...
#=============================
parameter_space_nn = {
    'mlp__hidden_layer_sizes': hp.choice('hidden_layer_sizes',
                                         [(50,), (100,), (50, 50), (100, 50), (128, 64)]),
    'mlp__activation':         hp.choice('activation', ['tanh', 'relu']),
    'mlp__solver':             hp.choice('solver',     ['sgd', 'adam']),
    'mlp__alpha':              hp.loguniform('alpha', np.log(1e-7), np.log(1e-2)),
    'mlp__learning_rate':      hp.choice('learning_rate', ['constant', 'adaptive']),
    'mlp__learning_rate_init': hp.loguniform('lr_init', np.log(1e-4), np.log(1e-1)),
    'mlp__momentum':           hp.uniform('momentum', 0.5, 0.99),  # used if solver='sgd'
    'mlp__batch_size':         hp.choice('batch_size', [32, 64, 128]),
}
...
def nn_objective(params):
    ...
    # neg MSE for scoring; cross_val_score maximizes score
...
#=============================
choice_mappings = {
    'hidden_layer_sizes': [(50,), (100,), (50, 50), (100, 50), (128, 64)],
...
plt.tight_layout()
plt.savefig('xgbr_true_vs_pred.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('xgbr_shap_summary_bar.png', dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig('xgbr_shap_beeswarm.png', dpi=300)
plt.show()
